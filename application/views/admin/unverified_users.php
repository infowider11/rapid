			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Unverified Users List</h3>
...
?>                            
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <a href="<?php echo site_url().'admin/unverified_users'; ?>" class="btn btn-primary py-3 px-5" style="width:auto; height:auto">Reset Filter</a>
        				</div>
                     </div>
