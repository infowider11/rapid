...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>Rating List<small>management</small></h1>
		<!-- <ol class="breadcrumb">
...
?>
		...
		<tr>
			<td><?php echo $x; ?></td>
	    <td><?php
$report_by = $this->common_model->GetSingleData('users', array('id'=>$value["rate_by"]));
 if ($report_by["nickname"] !="") {
?>
<a href="<?php echo base_url(); ?>admin/users?UserId=<?php echo $value["rate_by"]; ?>" ><?php echo $report_by["nickname"]; ?></a><br>
<?php
} else {
  ?>
<a href="<?php echo base_url(); ?>admin/users?UserId=<?php echo $value['rate_by']; ?>" >Profile not updated</a><br>
  <?php
}
echo $report_by["uniqueID"]; ?></td>
	    <td><?php 
$report_to = $this->common_model->GetSingleData('users', array('id'=>$value["rate_to"]));
 if ($report_to["nickname"] !="") {
?>
<a href="<?php echo base_url(); ?>admin/users?UserId=<?php echo $value["rate_to"]; ?>" ><?php echo $report_to["nickname"]; ?></a><br>
<?php
} else {
  ?>
<a href="<?php echo base_url(); ?>admin/users?UserId=<?php echo $value['rate_to']; ?>" >Profile not updated</a><br>
  <?php
}
echo $report_to["uniqueID"];
    ...
    <td><?php echo $value["rating"]; ?></td>				     
	    <td><?php
$category = $this->common_model->GetSingleData('rating_category', array('id'=>$value["category"]));
