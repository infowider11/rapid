			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Email Information Agent Add</h3>
						<div id="MessageErr"></div>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<form role="form" method="post" action="<?php echo base_url(); ?>Admin/Email/email_builder_agent_Update">
				<div class="box-body">
					<div class="row">
						<div class="col-md-8 alert alert-primart">Keywords: [username] (for name), [email] (for email), [password] (for password) , [login_link] (for agent login link)
						</div>
					</div>
						<div class="row">
							<div class="col-md-6">
