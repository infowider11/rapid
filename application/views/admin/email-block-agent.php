			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Email Agent Block For Hostess</h3>
						<?php echo $this->session->flashdata('msgs'); ?>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<form role="form" method="post" action="<?php echo base_url(); ?>Admin/Email/email_builder_agent_Block">
				<div class="box-body">
					<div class="row">
						<div class="col-md-8 alert alert-primary">Keywords: [username] (for name),  [messageByAdmin] (Message from admin).
						</div>
					</div>
						<div class="row">
							<div class="col-md-6">
