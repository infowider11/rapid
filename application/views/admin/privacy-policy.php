					...
					<form role="form" method="post" onsubmit="return updatePrivacy();" id="updatePrivacy">
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="title" value="<?php echo $privacy_policy['title'];?>" required>
							</div>
							<div class="form-group">
								<label class="form-control-label">Description</label>
								<textarea class="form-control ckeditor" name="text" required><?php echo $privacy_policy['text'];?></textarea>
							</div>
						</div>
...
<script>
 ...
 $.ajax({
    url: "<?php echo base_url(); ?>Admin/ContentManagment/privacy_policyEdit",
    type:"POST",
    cache:false,
        contentType: false,
        processData: false,
