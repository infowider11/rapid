			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Top Rich List</h3>
                    ...
                    <option <?= (isset($_REQUEST['filter']) && $_REQUEST['filter']=='Year') ? 'selected' : ''; ?>  value="Year">Monthly Rank</option>
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <a href="<?php echo site_url().'admin/top_rich'; ?>" class="btn btn-primary py-3 px-5" style="width:auto; height:auto">Reset Filter</a>
        				</div>
                     </div>
