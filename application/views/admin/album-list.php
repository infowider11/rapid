...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1><?php echo $content; ?> Album<small>management</small></h1>
		<!-- <ol class="breadcrumb">
...
?></td>
	        ...
	        <td><img src="<?php echo base_url().$value["file"]; ?>" width="100px" height="100px"/></td>
...
if ($value["status"]=="0") {
?>
<a class="btn btn-success btn-xs" onclick="return confirm('Are you sure?')" href="<?php echo base_url();?>Admin/Album/Accept?id=<?php echo $value["id"];?>&status=1" ><i class="fa fa-check" aria-hidden="true"></i></a>
<a class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?')" href="<?php echo base_url();?>Admin/Album/Accept?id=<?php echo $value["id"];?>&status=2" ><i class="fa fa-times" aria-hidden="true"></i></a>

<?php
} 

?>
	 <a class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?')" href="<?php echo base_url();?>Admin/Album/DeleteAlbum?id=<?php echo $value["id"];?>&page=<?php echo $this->uri->segment(2); ?>" ><i class="fa fa-trash" aria-hidden="true"></i></a>   
	    </td>				
		</tr>
