   ...
   ?>
                              <div id="MessageErr"></div>
                                 ...
                                 <div class="otp_submit text-center form-group">                                    
                                    <span class=""><button type="button" class="btn btn-primary col-xs-12" id="sendCode">Send otp</button></span>
                                    <span class="" id="sendAgainCode" style="display: none; margin-top: 5px;"><button type="button" id="sendCodeAgain">Resend OTP</button></span>
                                 </div>                           
...
$(document).on('click', '#sendCode', function () {
   ...
   if (Email === '') {
     alert("Please enter your email id."); 
      ...
      $.ajax({
         url : "<?php echo base_url(); ?>Home/sentCodeEmailHostess",
         method: "post",
         dataType:'json',
...
$(document).on('click', '#sendCodeAgain', function () { 
      ...
      $.ajax({
         url : "<?php echo base_url(); ?>Home/sentAgainCodeHostess",
         method: "post",
         dataType:'json',
         success: function(data) {
         if(data.status==1){
