                        ...
                        <div class="col-xs-12">
                           ...
                           <div id="login-box-inner">
                            <?php echo $this->session->flashdata('msgs'); ?>
										<form method="post" >
                                 <input type="text" name="UserId" value="<?php echo $this->uri->segment(3); ?>">
                                 ...
                                 <div class="row">
                                    <div class="col-xs-12">
                                       <button type="submit" class="btn btn-success col-xs-12 submit_btn">Verify<i style="display:none" class="spinner fa fa-spinner fa-spin fa-fw btn-load"></i></button>
                                    </div>
                                 </div>
                              </form>
                           </div>
...
function SignUP() {
 $.ajax({
    ...
    success:function(data) {
      if(data.status==1){
        window.location.href='../verify-otp/'+data.UserId;
      } 
      else {
