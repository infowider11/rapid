			 ...
			 <div class="col-lg-12">
				<div class="row">
				   <div class="col-lg-12">
					  <ol class="breadcrumb">
						 <li><a href="#">Home</a></li>
						 <li class="active"><span>Sub Agent List</span></li>
					  </ol>
				   </div>
				</div>
		...
		<div class="tab-content tab-content-body clearfix">
		   <div class="tab-pane fade active in" id="Agreed-List">
			  <div class="main-box clearfix">
                ...
                <div class="col-md-3">
                	<br>
                	<a href="<?php echo site_url().'agent/sub-agent'; ?>" class="btn btn-primary py-3 px-5" style="width:auto; height:auto">Reset Filter</a>                          
        				</div>
                     </div>
...
/*if ($Users["status"] ==1) {
 ...
 ?>                       	 		
                    ...
                    <a onclick="return  confirm('Are you sure want to delete this sub agent?');" href="<?php echo base_url();?>agent/User/delete_Users?UserId=<?php echo $Users['id'];?>"  class="btn btn-xs btn-danger">Delete</a>
...
<script>
 function Add() {
 $.ajax({
    url: "<?php echo base_url(); ?>agent/User/AddSubAgent",
    type:"POST",
    cache:false,
        contentType: false,
        processData: false,
 ...
 $.ajax({
    url: "<?php echo base_url(); ?>agent/User/EditSubAgent",
    type:"POST",
    cache:false,
    contentType: false,
    processData: false,
